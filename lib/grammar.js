 ...
 * @generatedfrom ./grammar.macro.js#c21fae3df713f440fc7436340a359950161554a3
...
export const grammar = class BABLRVMInstructionGrammar {
  ...
  *Expression() {
    yield eat(m`<_Any />`, [m`<IJSON:Array '[' />`, m`<IJSON:Object '{' />`, m`<JSON:Boolean /true|false/ />`, m`<JSON:Null 'null' />`, m`<JSON:Number /[\d]|[+-]?Infinity/ />`, m`<SpamexString /m["'\u0060]/ />`, m`<CSTMLString /t["'\u0060]/ />`, m`<RegexString /re["'\u0060]/ />`, m`<JSON:String /["']/ />`]);
  }
  *SpamexString({
    ctx
  }) {
