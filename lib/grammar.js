 ...
 * @generatedfrom ./grammar.macro.js#08d7490d812bf13ed32978ca810275bbeecfac82
...
export const grammar = class BABLRVMInstructionGrammar {
  static {
    [_initProto] = _applyDecs(this, [[Node, 2, "Call"], [Node, 2, "SpamexString"], [Node, 2, "CSTMLString"], [_ArrayDecs, 2, "Array"], [_ObjectDecs, 2, "Object"], [Node, 2, "Property"], [_TupleDecs, 2, "Tuple"], [_BooleanDecs, 2, "Boolean"], [_NullDecs, 2, "Null"], [Node, 2, "Identifier"], [Node, 2, "UnsignedInteger"], [_IntegerDecs, 2, "Integer"], [Node, 2, "Digit"], [_InfinityDecs, 2, "Infinity"], [_PunctuatorDecs, 2, "Punctuator"], [_KeywordDecs, 2, "Keyword"], [_AnyDecs, 2, "Any"]], []).e;
  }
  constructor() {
    _initProto(this);
  }
  *[(_ArrayDecs = [CoveredBy('Expression'), Node], _ObjectDecs = [CoveredBy('Expression'), Node], _TupleDecs = [CoveredBy('Expression'), Node], _BooleanDecs = [CoveredBy('Expression'), Node], _NullDecs = [CoveredBy('Expression'), Node], _IntegerDecs = [CoveredBy('Number'), Node], _InfinityDecs = [CoveredBy('Number'), Node], _PunctuatorDecs = [Node, InjectFrom(productions)], _KeywordDecs = [Node, InjectFrom(productions)], _AnyDecs = InjectFrom(productions), "Call")]() {
    yield eat(m`callee$: <*Identifier />`);
    yield* eatMatchTrivia();
    yield eat(m`arguments$: <Tuple />`);
  }
  *Expression() {
    yield eat(m`<Any />`, [m`<Array '[' />`, m`<Object '{' />`, m`<Tuple '(' />`, m`<*Boolean /true|false/ />`, m`<*Null 'null' />`, m`<Number /[\d]|[+-]?Infinity/ />`, m`<SpamexString /m["'\`]/ />`, m`<CSTMLString /c["'\`]/ />`]);
  }
  *SpamexString() {
