 ...
 * @generatedfrom ./grammar.macro.js#7c3034e249659e2364cc715d3853dd388ae47044
...
export const grammar = (_dec = CoveredBy('Expression'), _dec2 = CoveredBy('Expression'), _dec3 = CoveredBy('Expression'), _dec4 = CoveredBy('Expression'), _dec5 = CoveredBy('Expression'), _dec6 = CoveredBy('Expression'), _dec7 = CoveredBy('Number'), _dec8 = CoveredBy('Number'), _dec9 = InjectFrom(productions), _dec10 = InjectFrom(productions), _dec11 = InjectFrom(productions), class BABLRVMInstructionGrammar {
  static {
    [_initProto] = _applyDecs(this, [[Node, 2, "Call"], [[_dec, Node], 2, "Array"], [[_dec2, Node], 2, "Object"], [Node, 2, "Property"], [[_dec3, Node], 2, "Tuple"], [[_dec4, Node], 2, "Boolean"], [[_dec5, Node], 2, "Null"], [[_dec6, Node], 2, "Identifier"], [Node, 2, "UnsignedInteger"], [[_dec7, Node], 2, "Integer"], [Node, 2, "Digit"], [[_dec8, Node], 2, "Infinity"], [[Node, _dec9], 2, "Punctuator"], [[Node, _dec10], 2, "Keyword"], [_dec11, 2, "Any"]], []).e;
  }
  constructor(...args) {
    _initProto(this);
  }
